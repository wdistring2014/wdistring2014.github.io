var stringObjects = [
  ...
  {name: 'Ben Ticsay',
   intro: 'Jr Web Developer & Marketer with an emphasis on Client-Side, seeking FT/Contract work. Preference for Growth-Stage Startups. Since graduating with my degree in international business in 2013, I have done marketing for startups and technology companies.',
  ...
  {name: 'Victor Rodriguez',
   ...
   twitter: '',
   email: '',
   image: 'images/string/cropped/victor.jpg'},
  {name: 'Zach Levine',
   intro: ".",
   portfolio: '',
   github: 'https://github.com/',
